...
business_owner_df.to_csv('/Downloads/Quasar/business_owner_data.csv', index=False)
non_business_owner_df.to_csv('/Downloads/Quasar/non_business_owner_data.csv', index=False)
