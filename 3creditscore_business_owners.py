...
scoring_rules = {
    ...
    "business_tenure": {"More than 3 years": 5, "2-3 years": 4, "1-23 months": 3, "6-23 months": 2, "Less than 6 months": 1},
    "ownership_of_business_premises": {'Owned': 10, 'Rented': 5, 'Rent-Free':4, 'Mortgaged':3, 'Owned (mortgaged)':2, 'Owned (unencumbered)':1},
    "number_of_paid_employees": {"More than 5": 5, "3-5": 4, "1-2": 3, "With paid helpers or employees": 3, "0": 1, 'Without paid helpers or relatives only': 1},
    "business_nature": {'Food and Hospitality': 5, 'Others': 1, 'Agriculture': 3, 'Business and Information ':3, 'Finance ':3, 'Education ': 3, 'Construction': 4,
                        'Gaming ': 3, 'Transportation & Storage': 3, 'Wholesale & Retail Trade; Repair of Motor Vehicles & Motorcycles': 4,
                        'Activities of Household as Employers; Undeferential Goods-and-Services-Producing Activities of Households for Own Use': 3,
                        'Other Service Activities': 3, 'Accommodation & Food Services Activities': 4},
...
output_path = 'data_business_owner_imputed_with_credit_score.csv'
